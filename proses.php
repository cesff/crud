...
if ($aksi == "tambah") {
    $biodata->create($nama2, $tanggal_lahir2,$tempat_lahir2,$jenis_kelamin2,
    $agama2,$alamat2,$motivasi_hidup2);
    header("location:index.php");
} elseif ($aksi == "update") {
    $biodata->update($id2, $nama2, $tanggal_lahir2,$tempat_lahir2,$jenis_kelamin2,
    $agama2,$alamat2,$motivasi_hidup2);
    header("location:index.php");
} elseif ($aksi == "delete") {
