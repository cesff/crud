...
class Biodata extends Database
{
    ...
    //Menambah Data
    public function create($nama1, $tanggal_lahir1,$tempat_lahir1,$jenis_kelamin1,
    $agama1,$alamat1,$motivasi_hidup1)
    {
        mysqli_query($this->koneksi, "insert into biodata values
        (null,'$nama1','$tanggal_lahir1','$tempat_lahir1','$jenis_kelamin1'
        ,'$agama1','$alamat1','$motivasi_hidup1')");
    }
    ...
    public function update($id1, $nama1, $tanggal_lahir1,$tempat_lahir1,$jenis_kelamin1,
    $agama1,$alamat1,$motivasi_hidup1)
    {
        mysqli_query($this->koneksi, "update biodata set 
        nama ='$nama1',
        ...
        agama='$agama1',
        alamat='$alamat1',
        motivasi_hidup='$motivasi_hidup1' 
        where id ='$id1' ");
    }
